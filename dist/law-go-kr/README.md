...
| 버전 | 파일 | 체크섬 |
|---|---|---|
| **1.0.2** | `law-go-kr-1.0.2.zip` | `law-go-kr-1.0.2.zip.sha256` |
...
```bash
shasum -a 256 -c law-go-kr-1.0.2.zip.sha256
# 또는 Linux: sha256sum -c law-go-kr-1.0.2.zip.sha256
```
...
unzip law-go-kr-1.0.2.zip -d ~/.claude/skills/
